...
|      関数      |         機能           |
| :-----------: | :--------------------: |
|  create_traking_animation  |  トラッキングデータのアニメーションを作成する  |
|  create_topic_animation    | 三つのトピックの pub/sub 関係付きトラッキングデータのアニメーションを作成する  |
|  create_single_topic_animation  |  一つのトピックの pub/sub 関係付きトラッキングデータのアニメーションを作成する  |
|  create_single_assign_animation  | 一つのトピックのエッジサーバに対するクライアント割り当て付きアニメーションを作成する |
|  create_assign_animation  |  三つのトピックのエッジサーバに対するクライアント割り当て付きアニメーションを作成する  |
|  create_opt_animation  |  最適なエッジサーバに対するクライアント割り当て付きアニメーションを作成する  |
|  create_single_opt_animation  |  一つのトピックの最適なエッジサーバに対するクライアント割り当て付きアニメーションを作成する　|

### create_traking_animation 関数

|   引数   | パラメータ | デフォルト値 |            説明               |
| :------: | :------: | :-------: | :-----------------------------: |
| 第 1 引数 |  index_file |   無し   |  index_file のパス  |
| 第 2 引数 |  out_file |   無し   |  アニメーションを出力する先のパス  |
| 第 3 引数 |  FPS |   20   |  生成するアニメーションの FPS  |

この関数は index_file で指定されたファイルを読み込み、traking_file のパスを取り出す。
取り出した traking_file を元にアニメーションを作成する。

### create_topic_animation 関数
...
この関数は index_file で指定されたファイルを読み込み、assign_file のパスを取り出す。
取り出した assign_file を元にアニメーションを作成する。

この関数ではトピックが3つのデータを扱う

### create_single_topic_animation 関数
...
この関数ではトピックが一つのデータを扱う

### create_single_assign_animation 関数
...
この関数は index_file で指定されたファイルを読み込み、solve_file のパスを取り出す。
取り出した solve_file を元にアニメーションを作成する。

この関数ではトピックが1つのデータを扱う

### create_assign_animation 関数
...
### create_opt_animation 関数

|   引数   | パラメータ | デフォルト値 |            説明               |
| :------: | :------: | :-------: | :-----------------------------: |
| 第 1 引数 |  index_file |   無し   |  index_file のパス  |
| 第 2 引数 |  out_file |   無し   |  アニメーションを出力する先のパス  |
| 第 3 引数 |  opt_solution |   無し   |  最適解が記述されたファイルのパス  |
| 第 4 引数 |  FPS |   20   |  生成するアニメーションの FPS  |

この関数は index_file で指定されたファイルと、opt_solution で指定されたファイルを読み込み各種設定と最適解を取り出す。
取り出した 最適解 を元にアニメーションを作成する。

この関数ではトピックが3つのデータを扱う

### create_single_opt_animation 関数
